...
const Proyectos = () => {
  return (
    ...
    <div style={ContainerStyles}>
      ...
      <div style={ContainerStyles}>
        <h2 style={subtitleStyles}>Sitio Web de Comercio Electrónico</h2>
      ...
      <div style={ContainerStyles}>
        <h2 style={subtitleStyles}>Aplicación Móvil de Gestión de Tareas</h2>
      ...
      <div style={ContainerStyles}>
        <h2 style={subtitleStyles}>Plataforma de Aprendizaje en Línea</h2>
      ...
      <div style={ContainerStyles}>
        <h2 style={subtitleStyles}>Sitio Web Corporativo</h2>
